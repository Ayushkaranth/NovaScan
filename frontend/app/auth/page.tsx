      ...
      <div className="w-full max-w-md">
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="login">
            <div className="bg-white rounded-3xl border p-10 shadow-2xl text-center">
              <ShieldCheck className="w-12 h-12 text-indigo-600 mx-auto mb-4" />
              <h1 className="text-xl font-bold mb-2">Welcome Back</h1>
              <p className="text-slate-500 text-sm mb-8">Securely sign in to your workspace</p>
          ...
          <TabsContent value="register">
            <div className="bg-white rounded-3xl border p-10 shadow-2xl text-center">
              ...
              <p className="text-slate-500 text-sm mb-8">Join NovaScan with your work Google account</p>
